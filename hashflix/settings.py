...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['fulfilling-solace-production.up.railway.app/', 'fulfilling-solace-production.up.railway.app/']
else:
...
ALLOWED_HOSTS = ['fulfilling-solace-production.up.railway.app/', 'fulfilling-solace-production.up.railway.app/', 'localhost', '127.0.0.1']
